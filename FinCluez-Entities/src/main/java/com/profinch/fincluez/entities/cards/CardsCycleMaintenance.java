...
@Getter
@Setter
@SequenceGenerator(name = "Seq_CardsCycleMaintenanceId", sequenceName = "Seq_CardsCycleMaintenanceId", initialValue = 1, allocationSize = 100)
public class CardsCycleMaintenance implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(generator = "Seq_CardsCycleMaintenanceId")
	private BigDecimal id;
	private String collectionCycle;
	@Temporal(TemporalType.DATE)
	private Date dateCycleStart;
	@Temporal(TemporalType.DATE)
	private Date dateCycleEnd;
	@Version
